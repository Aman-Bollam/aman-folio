        ...
        <div className="max-w-4xl mx-auto mt-11 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                <h2 className="text-xl md:text-2xl font-light mb-2">Email</h2>
                <a
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-light mb-2">LinkedIn</h2>
                <a
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-light mb-2">GitHub</h2>
                <a
